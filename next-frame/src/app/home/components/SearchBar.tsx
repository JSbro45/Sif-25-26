    ...
    return (
        <form className="search-container" role="search" action="#" method="get" >
            <svg className="icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <path d="M21 21l-4.35-4.35" stroke="#1b8007" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="11" cy="11" r="6" stroke="#1b8007" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
